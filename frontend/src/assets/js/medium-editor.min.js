	...
	!(function (a) {
		...
		if ("Element" in a) {
			var b = "classList",
				...
				j = function (a) {
					for (
						var b = f.call(a.getAttribute("class") || ""), c = b ? b.split(/\s+/) : [], d = 0, e = c.length;
						e > d;
						d++
					)
						this.push(c[d]);
			...
			(function (a) {
				...
				return (
					...
					(f.slice = function (a, b, c) {
						...
						return (
							3 > e && (c = null), new d(this.data.slice(a, e > 1 ? b : this.data.length), c, this.encoding)
						);
					}),
					(f.toString = function () {
						return "[object Blob]";
			...
			return (
					...
					var h = {
						...
						createLink: function (a, b, c, d) {
							...
							return (
								...
								d &&
									("_blank" === d && e.setAttribute("rel", "noopener noreferrer"),
									...
									if (3 === i.nodeType) {
										if (
											(!g &&
												...
												((g = !0), (j = h.splitStartNodeIfNeeded(i, c.start, f))),
						...
						insertHTMLCommand: function (b, c) {
							...
							if (((d = b.getSelection()), d.rangeCount)) {
								if (
									...
									(3 === k.nodeType && 0 === e.startOffset && e.endOffset === k.nodeValue.length) ||
							...
							if ("a" === a.nodeName.toLowerCase()) (a.target = "_blank"), (a.rel = "noopener noreferrer");
								...
								for (a = a.getElementsByTagName("a"), c = 0; c < a.length; c += 1)
									(!1 !== d && d !== a[c].attributes.href.value) ||
										((a[c].target = "_blank"), (a[c].rel = "noopener noreferrer"));
						},
							...
							if ("a" === a.nodeName.toLowerCase()) a.removeAttribute("target"), a.removeAttribute("rel");
								...
								for (a = a.getElementsByTagName("a"), c = 0; c < a.length; c += 1)
									b === a[c].attributes.href.value &&
										(a[c].removeAttribute("target"), a[c].removeAttribute("rel"));
						},
						...
						splitOffDOMTree: function (a, b, c) {
							for (var d = b, e = null, f = !c; d !== a; ) {
								...
								for (e && (f ? i.appendChild(e) : (g = e)), e = i; j; ) {
									var k = j.nextSibling;
									j === d
										? (j.hasChildNodes() ? (j = j.cloneNode(!1)) : j.parentNode.removeChild(j),
						...
						isBlockContainer: function (a) {
							return (
								a &&
								3 !== a.nodeType &&
								-1 !== h.blockContainerElementNames.indexOf(a.nodeName.toLowerCase())
							);
						},
						...
						getFirstTextNode: function (a) {
							return (
								h.warn("getFirstTextNode is deprecated and will be removed in version 6.0.0"),
						...
						unwrap: function (a, b) {
							for (
								var c = b.createDocumentFragment(), d = Array.prototype.slice.call(a.childNodes), e = 0;
								e < d.length;
								e++
							)
								c.appendChild(d[e]);
					...
					var c = {
						findMatchingSelectionParent: function (b, c) {
							...
							return 0 === f.rangeCount
								? !1
								: ((d = f.getRangeAt(0)), (e = d.commonAncestorContainer), a.util.traverseUp(e, b));
						},
						...
						importSelection: function (a, b, c, d) {
							if (a && b) {
								...
								var f,
									...
									o = null;
								for (
									(d || a.startsWithImage || "undefined" != typeof a.emptyBlocksIndex) && (n = !0);
									!m && g;
									...
									if (g.nodeType > 3) g = h.pop();
										...
										if (3 !== g.nodeType || k) {
											if (
												...
												k &&
												("img" === g.nodeName.toLowerCase() && l++, l === a.trailingImageCount)
											) {
											...
											(f = i + g.length),
												!j &&
													a.start >= i &&
													a.start <= f &&
													(n || a.start < f ? (e.setStart(g, a.start - i), (j = !0)) : (o = g)),
												j &&
													a.end >= i &&
													a.end <= f &&
													(a.trailingImageCount ? (k = !0) : (e.setEnd(g, a.end - i), (m = !0))),
												(i = f);
										m || (g = h.pop());
									}
								!j && o && (e.setStart(o, o.length), e.setEnd(o, o.length)),
									"undefined" != typeof a.emptyBlocksIndex &&
										(e = this.importSelectionMoveCursorPastBlocks(c, b, a.emptyBlocksIndex, e)),
						...
						importSelectionMoveCursorPastBlocks: function (c, d, e, f) {
							...
							for (
								e = e || 1,
									g =
										3 === j.nodeType && a.util.isBlockContainer(j.previousSibling)
											? j.previousSibling
						...
						doesRangeStartWithImages: function (a, b) {
							...
							if (!c) return !1;
							for (
								var d = b.createTreeWalker(a.startContainer, NodeFilter.SHOW_ALL, null, !1);
								d.nextNode();
						...
						selectionContainsContent: function (a) {
							...
							return !(
								!c || !("img" === c.nodeName.toLowerCase() || (1 === c.nodeType && c.querySelector("img")))
							);
						},
						...
						getSelectionHtml: function (a) {
							var b,
								...
								f = a.getSelection();
							if (f.rangeCount) {
								for (d = a.createElement("div"), b = 0, c = f.rangeCount; c > b; b += 1)
				...
				(function () {
					...
					(c.prototype = {
						...
						updateFocus: function (c, d) {
							...
							e !== f &&
								(f && g && (f.removeAttribute("data-medium-focused"), this.triggerCustomEvent("blur", d, f)),
								e && (e.setAttribute("data-medium-focused", !0), this.triggerCustomEvent("focus", d, e))),
						...
						handleKeypress: function (a) {
							if (
								(this.triggerCustomEvent("editableKeypress", a, a.currentTarget), this.keypressUpdateInput)
							) {
					...
					var b = a.extensions.form.extend({
						...
						handleClick: function (b) {
							...
							return "a" === c.startContainer.nodeName.toLowerCase() ||
								...
								a.util.getClosestTag(a.selection.getSelectedParentElement(c), "a")
						...
						getFormOpts: function () {
							...
							return (
								this.linkValidation && (c.value = this.checkLinkFormat(c.value)),
								(c.target = "_self"),
						...
						handleTextboxKeyup: function (b) {
							return b.keyCode === a.util.keyCode.ENTER
								...
								: void (b.keyCode === a.util.keyCode.ESCAPE && (b.preventDefault(), this.doFormCancel()));
						},
				...
				(function () {
					var b = a.Extension.extend({
						...
						showPreview: function (a) {
							return this.anchorPreview.classList.contains("medium-editor-anchor-preview-active") ||
								a.getAttribute("data-disable-preview")
								? !0
								: (this.previewValueSelector &&
										((this.anchorPreview.querySelector(this.previewValueSelector).textContent =
						...
						positionPreview: function (a) {
							...
							var b,
								...
								m =
									["absolute", "fixed"].indexOf(window.getComputedStyle(l).getPropertyValue("position")) >
									-1,
								n = {};
						...
						handleEditableMouseover: function (b) {
							...
							if (!1 !== c) {
								if (
									...
									(!/href=["']\S+["']/.test(c.outerHTML) || /href=["']#\S+["']/.test(c.outerHTML))
								)
									return !0;
				...
				(function () {
					...
					var h = a.Extension.extend({
						...
						removeObsoleteAutoLinkSpans: function (c) {
							...
							for (
								var d = c.querySelectorAll('span[data-auto-link="true"]'), e = !1, f = 0;
								f < d.length;
								f++
							) {
								var g = d[f].textContent;
								if (
									(-1 === g.indexOf("://") && (g = a.util.ensureUrlHasProtocol(g)),
							...
							for (var c = !1, d = 0; d < b.length && c === !1; d++)
								c = !!a.util.traverseUp(b[d], function (a) {
									return (
										...
										(a.getAttribute && "true" === a.getAttribute("data-auto-link"))
									);
								});
							return c;
						},
						findLinkableText: function (a) {
							for (var b = a.textContent, d = null, e = []; null !== (d = g.exec(b)); ) {
								...
								(h = !(
									...
									(h =
										h && (-1 !== d[0].indexOf("/") || f.test(d[0].split(".").pop().split("?").shift()))),
						...
						h = a.Extension.extend({
							...
							handlePasteBinPaste: function (a) {
								...
								return !this.cleanPastedHTML || d
									? (a.preventDefault(),
										this.removePasteBin(),
										this.doPaste(d, e, g),
										void this.trigger("editablePaste", { currentTarget: g, target: g }, g))
									: void setTimeout(
											function () {
												this.cleanPastedHTML && (d = this.getPasteBinHtml()),
													this.removePasteBin(),
													this.doPaste(d, e, g),
													this.trigger("editablePaste", { currentTarget: g, target: g }, g);
											}.bind(this),
											0
										);
							},
							handleKeydown: function (b, c) {
								a.util.isKey(b, a.util.keyCode.V) &&
									a.util.isMetaCtrlKey(b) &&
									(b.stopImmediatePropagation(), this.removePasteBin(), this.createPasteBin(c));
							},
							...
							removePasteBin: function () {
								null !== e && (a.selection.selectRange(this.document, e), (e = null)),
									null !== f && (f = null);
							...
							filterLineBreak: function (a) {
								this.isCommonBlock(a.previousElementSibling)
									...
									: !this.isCommonBlock(a.parentNode) ||
										  (a.parentNode.firstChild !== a && a.parentNode.lastChild !== a)
										? a.parentNode &&
							...
							removeWithParent: function (a) {
								a &&
									a.parentNode &&
									(a.parentNode.parentNode && 1 === a.parentNode.childElementCount
							...
							cleanupSpans: function (b) {
								...
								for (c = 0; c < f.length; c += 1)
									(d = f[c]),
										...
										d.classList.contains("bold") && d.classList.contains("italic")
				...
				(function () {
					var b = a.Extension.extend({
						...
						destroy: function () {
							this.toolbar &&
								(this.toolbar.parentNode && this.toolbar.parentNode.removeChild(this.toolbar),
								delete this.toolbar);
						},
						getInteractionElements: function () {
						...
						handleDocumentMouseup: function (b) {
							return b && b.target && a.util.isDescendant(this.getToolbarElement(), b.target)
								? !1
							...
							if (
								...
								(this.forEachExtension(function (a) {
									return "function" == typeof a.queryCommandState &&
										...
										? void (d && "function" == typeof a.setActive && a.setActive())
										: void c.push(a);
								}),
						...
						setToolbarPosition: function () {
							...
							return a
								? void (
										...
										(this.showToolbar(),
										this.relativeContainer ||
											(this["static"] ? this.positionStaticToolbar(a) : this.positionToolbar(b)),
						...
						positionStaticToolbar: function (a) {
							...
							var b,
								c =
									(this.document.documentElement && this.document.documentElement.scrollTop) ||
						...
						positionToolbar: function (a) {
							...
							(!c || (0 === c.height && 0 === c.width && b.startContainer === b.endContainer)) &&
								(c =
									1 === b.startContainer.nodeType && b.startContainer.querySelector("img")
										? b.startContainer.querySelector("img").getBoundingClientRect()
							...
							var d,
								...
								n =
									["absolute", "fixed"].indexOf(window.getComputedStyle(m).getPropertyValue("position")) >
									-1,
								o = {},
								p = {};
							n
											...
											if (b.type.match("image")) {
												...
												(c = new FileReader()),
													...
													a.util.insertHTMLCommand(
														this.document,
														'<img class="medium-editor-image-loading" id="' + d + '" />'
													),
													(c.onload = function () {
				...
				(function () {
					...
					function e(b) {
						...
						0 === a.selection.getCaretOffsets(d).left
							? a.util.isKey(b, a.util.keyCode.BACKSPACE) && f.test(d.previousElementSibling.innerHTML)
								? (d.previousElementSibling.parentNode.removeChild(d.previousElementSibling),
									b.preventDefault())
							...
							: a.util.isKey(b, a.util.keyCode.DELETE) &&
								...
								? (a.selection.moveCursor(this.options.ownerDocument, d.nextElementSibling),
					...
					function g(a, b) {
						var c = b.parentNode.querySelector(
							'textarea[medium-editor-textarea-id="' + b.getAttribute("medium-editor-textarea-id") + '"]'
						);
					...
					function k(a) {
						...
						b && (b.classList.remove("medium-editor-hidden"), b.removeAttribute("medium-editor-textarea-id")),
						...
						return (
							a.form &&
								this.on(
									...
									function (a) {
										a.defaultPrevented ||
											this.resetContent(this.options.ownerDocument.getElementById(d));
									}.bind(this)
								),
					...
					function z(b, c) {
						...
						if ("fontSize" === b)
							return (
								c.size && a.util.deprecated(".size option for fontSize command", ".value", "6.0.0"),
								(e = c.value || c.size),
								this.options.ownerDocument.execCommand("fontSize", !1, e)
							);
						if ("fontName" === b)
							return (
								c.name && a.util.deprecated(".name option for fontName command", ".value", "6.0.0"),
								(e = c.value || c.name),
					...
					(a.prototype = {
							...
							switch (b) {
								...
								default:
									a.extensions.button.isBuiltInButton(b) &&
										(c
											? ((d = a.util.defaults({}, c, a.extensions.button.prototype.defaults[b])),
						...
						execAction: function (b, c) {
							...
							return (
								...
								("insertunorderedlist" !== b && "insertorderedlist" !== b) ||
									a.util.cleanListDOM(this.options.ownerDocument, this.getSelectedParentElement()),
								this.checkSelection(),
								e
							);
						},
						getSelectedParentElement: function (b) {
							return (
								void 0 === b && (b = this.options.contentWindow.getSelection().getRangeAt(0)),
						...
						exportSelection: function () {
							var b = a.selection.getSelectionElement(this.options.contentWindow),
								...
								d = null;
							return (
								c >= 0 && (d = a.selection.exportSelection(b, this.options.ownerDocument)),
							...
							return 0 === b.length
								...
								: void b.forEach(function (a) {
										(a = v.call(this, a, this.id)),
											...
											this.trigger("addElement", { target: a, currentTarget: a }, a);
									}, this);
						},
						removeElements: function (a) {
							var b = j(a, this.options.ownerDocument),
								c = b.map(function (a) {
									return a.getAttribute("medium-editor-textarea-id") && a.parentNode
							...
							this.elements = this.elements.filter(function (a) {
								return -1 !== c.indexOf(a)
									? (this.events.cleanupElement(a),
										a.getAttribute("medium-editor-textarea-id") && k(a),
										this.trigger("removeElement", { target: a, currentTarget: a }, a),
										!1)
									: !0;
							}, this);
						},
