	...
	$(".menu_steps, .menu_options .btn_toggler").on("click", function () {
		if ($(".menu_steps").attr("aria-expanded") === "false") {
			...
			if ($(".menu_navbar:not(.d-none) .btn_toggler_open").attr("aria-expanded") === "false") {
				...
				$(".coll_ghost_bg").css({
					"max-width": collGhostWidth,
					"z-index": "-2",
					"transition": "max-width .375s ease-out, background-position .375s ease-out, z-index .375s ease-out",
				});
			} else {
				$(".nav_ghost_bg").css({
					"z-index": "-1",
			...
			if ($(".menu_navbar:not(.d-none) .btn_toggler_open").attr("aria-expanded") === "false") {
				...
				$(".coll_ghost_bg").css({
					"max-width": collGhostWidth,
					"z-index": "-1",
					"transition": "max-width .375s ease-out, background-position .375s ease-out",
				});
			} else {
				$(".nav_ghost_bg").css({
					"z-index": "-2",
