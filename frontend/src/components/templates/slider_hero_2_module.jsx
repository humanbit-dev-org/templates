...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template name="slider_hero_2_module">

		<div class="slider_hero_2_module">
			<div class="slider_img position-relative mb-0 mb-lg-0">
				...
				<div class="wrapper-arrows position-relative slider-for-home" data-slide-sm="1" data-slide-md="2" data-slide-lg="2">
