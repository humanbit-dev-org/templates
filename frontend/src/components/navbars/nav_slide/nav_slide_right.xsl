                                    ...
                                    <xsl:choose>
										<xsl:when test="$member-id != ''">
											<a class="menu_link menu_steps me-1 circle_cart collapsed" type="button" id="optionCounter" data-bs-toggle="collapse" data-bs-target="#menuOptions" aria-controls="menuOptions" aria-expanded="false" aria-label="Toggle cart" data-empty=".empty_cart" data-full=".full_cart">
												<i class="full_cart coll_white fa-solid fa-bag-shopping color_second text-start d-none" />
                            ...
                            <div class="option_items container_humanbit_1">
                                ...
                                <div class="position_wrapper position-relative py-5">
									...
									<div class="container_choices row justify-content-between align-items-center mt-3 mb-4">
                                        <xsl:choose>
                                            <xsl:when test="$member-id != ''">
                                                <a class="btn_book_option p text-uppercase fw-500 btn_bg_third d-block col-12 mb-4 mx-auto mt-2 px-2 px-md-5 py-3 option_unsaved btn_proceed_checkout" href="{$root}/checkout/{$testurl}">
                                    ...
                                    <h4 class="option_title mid_small fw-700 color_second border-bottom border-2 border_color_grayer mb-4 pb-3 title_checkout">
										<span class="smaller d-block fw_400 color_black mb-2"><xsl:value-of select="/data/translate/entry[code = 'or']/*[local-name() = $lanextended]" /></span>
                                                    ...
                                                    <xsl:for-each select="/data/member-order-open-detail/entry">
                                                        ...
                                                        <div id="cart_product_{$idSolution}" class="cart_product mt-4 pb-3 border-bottom border_color_second" data-ref="{$idSolution}">
                                                            <div class="higher_row justify-content-between mb-3 clearfix">
                                                                <a class="option_title smaller fw-500 pe-5 pe-lg-1 pe-xl-0" href="{$root}/{/data/member-order-open-detail-soluzione/entry[@id = $idSolution]/name-italian/@handle}"><xsl:value-of select="/data/member-order-open-detail-soluzione/entry[@id = $idSolution]/*[local-name() = $namelan]"/></a>
