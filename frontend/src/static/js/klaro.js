				...
				o(
					...
					function () {
						var e = r(this),
							...
							n = e.flags;
						return (
							"/" + t + "/" + String(void 0 === n && e instanceof RegExp && !("flags" in c) ? a.call(e) : n)
						);
					},
					{ unsafe: !0 }
				);
										...
										he(
											...
											he(Ee, {
												...
												text: [f(["consentModal", "description"])].concat(
													(y &&
														[" "].concat(f(["privacyPolicy", "text"], { privacyPolicy: y }))) ||
														[]
												),
											})
										)
						...
						},
						{
							...
							value: function () {
								...
								(h =
									1 === y.length
										? y[0]
										: [].concat(jt(y.slice(0, -2)), [y.slice(-2).join(" & ")]).join(", ")),
								...
								return d
									? he("div", { className: "cookie-modal" }, he("div", { className: "cm-bg" }), j)
									: j;
							},
						},
					]) && At(t.prototype, n),
												...
												try {
													for (k.s(); !(g = k.n()).done; ) {
														var _ = g.value,
															w = a[_];
														void 0 !== w &&
															(void 0 === a["original-" + _] && (a["original-" + _] = r[_]),
															(r[_] = w));
													}
												} catch (e) {
													k.e(e);
